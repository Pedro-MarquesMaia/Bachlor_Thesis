...
class Universe():
    def __init__(self):
        ...
        self.step = Fraction(2 ** 18)  # 262144
        self.tend = Fraction(5*1000*17300000)
    ...
    def calc_angular(self):
        ...
        for part in self.particles:
            angular += Math.crossproduct(part.position,part.velocity)
            print("start")
            print(angular)
...
def create_universe():
    cluster1 = create_cluster(1,"red",2*(10**27),-5,200,0)
    cluster2 = create_cluster(1,"blue",2*(10**27),5,300,1)
